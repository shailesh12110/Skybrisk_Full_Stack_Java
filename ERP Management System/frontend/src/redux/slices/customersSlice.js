...
// Customers
const customersSliceObj = createEntitySlice('customers', '/customers');
export const customersActions = customersSliceObj.actions;
export default customersSliceObj.reducer;
